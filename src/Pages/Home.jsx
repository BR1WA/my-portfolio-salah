...
const WORDS = ["AI & Data Science Master's Student", "Machine Learning Engineer", "Full Stack Developer"];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/f5b4e2e8-b5c4-4bf3-9f33-bbee4db9a8db/LPBqfD5R3u.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Passionate about leveraging machine learning to transform data into actionable insights and building innovative AI solutions.
                </p>
                ...
                {/* Social Links */}
                <div className="flex gap-4 justify-start mt-4" data-aos="fade-up" data-aos-delay="1600">
